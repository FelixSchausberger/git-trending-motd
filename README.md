...
```
[GE] gitea/deployment      Python ★1          today      
[GH] google/adk-go         Go     ★98   today today      An open-source, code-first Go toolkit for...
[GL] chaotic-aur/pkgbuilds -      ★12         today      PKGBUILDs for the chaotic-aur repo, mostly...
```
<!-- EXAMPLE_OUTPUT_END -->
