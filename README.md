...
```
[GH] google/adk-go    Go     ★146  today today      An open-source, code-first Go toolkit for...
[GE] gitea/helm-gitea Smarty ★77         today      Helm chart for gitea
[GL] micromorph/ratel -      ★10         today      Extensible, performance-portable solid mec...
```
<!-- EXAMPLE_OUTPUT_END -->
