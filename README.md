...
```
[GE] rozhuk.im/freebsd-ports   Makefile ★3          today      FreeBSD ports tree
[GH] google/adk-go             Go       ★163  today today      An open-source, code-first Go toolkit for...
[GL] sylva-projects/sylva-core -        ★34         today      This repository contains the core developm...
```
<!-- EXAMPLE_OUTPUT_END -->
