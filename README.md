...
```
[GH] google/adk-go       Go         ★97   today today      An open-source, code-first Go toolkit for...
[GL] lecarore/breakout71 Javascript ★37         today      An open source game about breaking bricks,...
```
<!-- EXAMPLE_OUTPUT_END -->
